...
<html lang="es">
    ...
    <style>
        ...
        .title{
            background-color: rgb(204, 217, 255) !important;
            /* rgb(0, 32, 96) !important; color: white; */
        }
        .sub_title{
            background-color: rgb(110, 173, 255) !important;
            /* rgb(0, 112, 192) !important; color: white; */
        }
        .disclaymer{
            color: rgb(154, 205, 179) !important;
            /* color: rgb(166, 212, 187) !important; */
        }
        .legal-terms{
            color: rgb(128, 167, 206) !important;
            /* color: rgb(206, 224, 255) !important; */
        }
    </style>
    <body>
        <main class="container">
            <div class="col-md-9" style="margin-top: 5%; margin-left: auto;margin-right: auto;">
                <div class="float-end">
                    <img class="" id="logo" src="gcs-logo.jfif" alt="RERORERORERO">
                </div>
                <center>
                    <p class="disclaymer"><b>Uso interno</b></p>
                ...
                <center>
                    <table class="table table-bordered table-hover">
                        <tr>
                            <td class="title card-text text-center"><b>DESCRIPCIÓN</b></td>
                            <td class="title card-text text-center"><b>DETALLES</b></td>
                        </tr>
                        <tr>
                            <td class="card-text text-center sub_title"><b>EQUIPO</b></td>
                            <td><p class="card-text data_content"><b>{$tipo_equipo}</b></p></td>
                        </tr>
                        <tr>
                            <td class="card-text text-center sub_title"><b>TIPO DE EQUIPO</b></td>
                            <td><p class="card-text data_content"><b>{$tipo_equipo}</b></p></td>
                        </tr>
                        <tr>
                            <td class="card-text text-center sub_title"><b>MARCA</b></td>
                            <td><p class="card-text data_content">{$equipos}</p></td>
                        </tr>
                        <tr>
                            <td class="card-text text-center sub_title"><b>SERIAL</b></td>
                            <td><p class="card-text data_content">{$seriales}</p></td>
                        </tr>
                        <tr>
                            <td class="card-text text-center sub_title"><b>NÚMERO TELEFÓNICO</b></td>
                            <td><p class="card-text data_content">qwertyu</p></td>
                        </tr>
                    </table>
                </center>
                    <br  />
